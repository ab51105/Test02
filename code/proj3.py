...
# support_vector_machine nearest_neighbor bag_of_sift
DATA_PATH = '../data/'
...
def main():
    ...
    if FEATURE == 'tiny_image':
        ...
        if os.path.isfile('vocab_400.pkl') is False:
            print('No existing visual word vocabulary found. Computing one from training images\n')
            vocab_size = 800   ### Vocab_size is up to you. Larger values will work better (to a point) but be slower to comput.
        ...
        if os.path.isfile('train_image_feats.pkl') is False:
            ...
            print('generate train_image_feats\n')
        ...
        if os.path.isfile('test_image_feats.pkl') is False:
            print('generate test_image_feats\n')
